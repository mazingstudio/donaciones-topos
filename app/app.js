document.write((function() {
  ...
  button += '<h1 style="margin:0 20px 0">Dona a los <a style="color:inherit;" target="_blank" href="https://topos.mx">topos.mx</a><div><small><a style="color:#fff; font-weight: 100; font-size: 1rem" target="_blank" href="https://twitter.com/hashtag/Sismomexico2017?src=tren&data_id=tweet%3A910583997314457600">#sismomexico2017</a></small></div></h1>';
  ...
  button += '</form>';
  var wrapper = '<div style="box-sizing: border-box; position: fixed; top: 0; left: 0; width: 100%; display:flex; justify-content: space-between; align-items: center; background-color:#9e1504; font-family:sans-serif; color:#fff; padding:10px;">' + button  +'</div>';
